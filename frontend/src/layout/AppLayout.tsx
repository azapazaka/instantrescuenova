      ...
      <div className="fixed inset-x-0 bottom-0 z-30 border-t border-line bg-white/95 shadow-calm backdrop-blur">
        <div className="mx-auto grid max-w-7xl grid-cols-[1fr_auto] items-center gap-1 px-1 py-1 sm:px-3 lg:grid-cols-[auto_1fr_auto] lg:gap-4 lg:px-8 lg:py-3">
          ...
          <div className="flex shrink-0 items-center gap-1 lg:gap-2">
            <ThemeToggle className="min-h-14 lg:min-h-12 lg:rounded-xl" />

            <div className="relative">
              <button
                type="button"
                onClick={() => setMenuOpen((open) => !open)}
                className="flex min-h-14 min-w-12 items-center justify-center rounded-lg border border-line bg-white px-2 font-extrabold text-ink lg:min-h-12 lg:min-w-0 lg:justify-start lg:gap-2 lg:rounded-xl lg:px-3"
